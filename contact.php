...
<?php 
    ...
    if(isset($_POST["submit"])){
        ...
        $secretKey ="6Lc5CagkAAAAAHjlE4DUm-CFdOy5yifXf1o0qHtC";
        ...
        if($response->success){
            if(mail($to, $subject, $msgBody, $header)){
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            <form action="server/contact.php" method="POST">
                                ...
                                <div class="form-floating">
                                    <input class="form-control" name="bot" id="bot" type="hidden" placeholder="You are bot"/>
                                ...
                                <br />
                                <div class="form-floating">
                                <div class="g-recaptcha" data-sitekey="6Lc5CagkAAAAACrsRwgth9OZ_7-EHNgH6YrFWYDd"></div>
                                </div>
